...
class LineChart extends React.Component {
	...
	drawCoordinate(index, start, end, backgroundColor, lineStyle, isBlank, lastCoordinate, seriesIndex) {
		...
		let gradientColor = this.props.gradientColor ? this.props.gradientColor : '#FFFFFF00';
	...
	drawCoordinates(data, seriesColor, seriesIndex) {
		...
		let lineStyle = {
			...
			borderTopWidth: this.props.lineWidth ? this.props.lineWidth : 1
		}
					...
					<View style={{flexDirection:'row',justifyContent:'flex-start'}}>
						...
						<ScrollView horizontal showsHorizontalScrollIndicator={false}>
							<View>
								...
								{drawXAxisLabels(this.state.sortedData[0].data, this.props.gap, this.props.labelColor, this.props.showEvenNumberXaxisLabel, this.props.xAxisLabelFontSize)}
							</View>
